...
urlpatterns = [
    ...
    path('activity/delete/<int:post_id>/', views.activity_delete, name='activity_delete'),
    ...
    path('free/delete/<int:post_id>/', views.free_delete, name='free_delete'),
    ...
    path('study/delete/<int:post_id>', views.study_delete, name='study_delete'),
